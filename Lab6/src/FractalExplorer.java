...
public class FractalExplorer {
    ...
    public void enableGUI(boolean b) { //включает или выключает кнопку из выподающего списка
    ...
    public class FractalWorker extends SwingWorker<Object, Object> { //отвечает за вычисление цвета одной строки фрактала
        private int y_coord;//координата вычисляемой строики
        private int[] rgb;//масив пикселей

        public FractalWorker(int y_coord) {
            this.y_coord = y_coord;
        }//получение координаты как параметр и сохраняет ее

        @Override
        protected Object doInBackground() throws Exception { //вычисляется и рисуется пиксель
